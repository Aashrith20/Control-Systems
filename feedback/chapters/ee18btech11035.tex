...
\begin{figure}[!ht]
    \begin{center}
		\resizebox{\columnwidth}{!}{\input{./figs/ee18btech11035_G.tex}}
	\end{center}
\caption{}
...
\item Tabulating Gain Bandwidth and Gain bandwidth product\\
\solution
\begin{table}[!ht]
\centering
...
Therefore,By using feedback we can get desired Gain of an amplifier while maintaining constant Gain Bandwidth product.
